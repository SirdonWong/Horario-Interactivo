  ...
  return (
    <div className="flex items-center gap-2 sm:gap-4">
      <label
        ...
        className="flex items-center px-2 py-1.5 sm:px-3.5 sm:py-1.5 bg-[var(--bg-app)] text-[var(--text-main)] rounded-lg text-[10px] sm:text-xs font-medium border border-[var(--border-subtle)] hover:border-[var(--border-strong)] transition-all shadow-sm cursor-pointer select-none"
      >
        <input
          id="csv-file-input"
          type="file"
