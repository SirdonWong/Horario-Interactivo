                            ...
                            <div className="flex justify-between items-center">
                              <div className="flex items-center space-x-3">
                                <button
                                  ...
                                  className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer items-center rounded-full transition-colors duration-200 ease-in-out border border-transparent select-none focus:outline-none ${todasCompletadas ? 'bg-[var(--color-primary)]' : 'bg-[var(--border-strong)]'
                                    }`}
                                ...
                                >
                                  <span
                                    className={`pointer-events-none inline-block h-3.5 w-3.5 transform rounded-full bg-white shadow-xs transition duration-200 ease-in-out ${todasCompletadas ? 'translate-x-[18px]' : 'translate-x-0.5'
                                      }`}
                                  />
                                </button>
                                <span
                                  ...
                                  {materias.map((m) => {
                                    ...
                                    return (
                                      <motion.div
                                        ...
                                        className={`flex items-center justify-between p-2.5 rounded-lg text-xs cursor-pointer transition-all border select-none ${isChecked
